...
class DashboardWidget(QtWidgets.QFrame):
    ...
    def __init__(self):
        ...
        self.layout().addWidget(DashboardTitle('Laptop mode'), 0, 0, 1, 9)
        self.layout().addWidget(DashboardImage('icons/laptop'), 1, 0)
    ...
    def linkClickedEvent(self, event):
        return webbrowser.open('https://www.kernel.org/doc/Documentation/laptops/laptop-mode.txt')
