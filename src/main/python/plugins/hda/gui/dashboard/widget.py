...
class DashboardWidget(QtWidgets.QFrame):
    ...
    def __init__(self):
        ...
        self.layout().addWidget(DashboardTitle('High Definition Audio'), 0, 0, 1, 9)
        self.layout().addWidget(DashboardImage('icons/hda'), 1, 0)
    ...
    def linkClickedEvent(self, event):
        return webbrowser.open('https://www.kernel.org/doc/html/latest/sound/hd-audio/notes.html')
